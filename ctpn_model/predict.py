...
from ctpn_model.ctpn import config
from ctpn_model.ctpn.ctpn import CTPN_Model
from ctpn_model.ctpn.utils import gen_anchor, transform_bbox, clip_bbox, filter_bbox, nms, TextProposalConnectorOriented


device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
weights = r'ctpn_model\weights\new.pth'
